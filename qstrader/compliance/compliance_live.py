...
class LiveCompliance(AbstractCompliance):
    """
    ...
    def __init__(self, config, tickers):
        ...
        if len(tickers) == 1:
            self.csv_filename = "tradelog_" + today.strftime("%Y_%m_%d_%Hh_%Mm") + "_" + tickers[0] + ".csv"
        elif len(tickers) == 2:
            self.csv_filename = "tradelog_" + today.strftime("%Y_%m_%d_%Hh_%Mm") + "_" + tickers[0] + "_" + tickers[1] + ".csv"
        elif len(tickers) == 3:
            self.csv_filename = "tradelog_" + today.strftime("%Y_%m_%d_%Hh_%Mm") + "_" + tickers[0] + "_" + tickers[1] + "_" + tickers[2] + ".csv"
