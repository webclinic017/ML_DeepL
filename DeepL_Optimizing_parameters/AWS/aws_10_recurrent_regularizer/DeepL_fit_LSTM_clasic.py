...
#################################################################################################################        
        ...
        for i in range(self.nLSTM - 2):
            model.add(LSTM(units=self.lstm_nodes, return_sequences=True, activation='tanh', recurrent_regularizer=regularizers.l1_l2(l1=0.01, l2=0.01)))
        model.add(LSTM(units=self.lstm_nodes, activation='tanh', recurrent_regularizer=regularizers.l1_l2(l1=0.01, l2=0.01)))
